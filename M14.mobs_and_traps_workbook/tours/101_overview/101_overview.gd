...
func _build() -> void:
	...
	# First step uses special format with centered text
	bubble_move_and_anchor(interface.base_control, Bubble.At.CENTER)
	bubble_set_avatar_at(Bubble.AvatarAt.CENTER)
	bubble_set_background(TEXTURE_BUBBLE_BACKGROUND)
	bubble_add_texture(TEXTURE_GDQUEST_LOGO)
	bubble_set_title("")
	bubble_add_text([bbcode_wrap_font_size("[center][b]Intro to tilesets and tilemaps in Godot![/b][/center]", 32)])
	bubble_add_text([
	...
	bubble_add_text([
		...
		"[ul]You can paint your levels' structure intuitively\n" +
	...
	bubble_add_text([
		...
		"The grid also makes it easy to paint your level: just click on a grid square to place a tile there.",
	...
	bubble_add_text([
		...
		"Click the [b]TileSet[/b] button at the bottom to switch from the [b]TileMap[/b] editor to the [b]TileSet[/b] editor.",
